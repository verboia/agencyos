  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Templates Meta Cloud API</h1>
          <p className="text-sm text-muted-foreground">
            Credenciais oficiais da Meta para envio de templates HSM (régua de cobrança, lembretes).
            Para grupos e relatórios, use a W-API em <Link href="/settings/whatsapp" className="underline">/settings/whatsapp</Link>.
          </p>
        </div>
      </div>
      ...
      {!config?.access_token && (
        <Alert>
          <AlertDescription>
            Sem credenciais, disparos de templates HSM rodam em modo mock: o evento é registrado mas nenhuma mensagem real é enviada.
          </AlertDescription>
        </Alert>
      )}
